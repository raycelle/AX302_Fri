...
// Draw our images when loaded
// onload - event after the image has finished loading and is ready
...
// Moon (circle)
ctx.beginPath();
ctx.arc(100,100,50,0, 6.28); //(x, y, radius, start angle, end angle)
ctx.closePath();
ctx.fillStyle = "ivory";
ctx.fill();
